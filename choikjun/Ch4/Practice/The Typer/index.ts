...
export type Beginstream = StreamBase & {
	area: "begin";
	downstream: Place;
};
export type MiddeStream = StreamBase & {
	area: "middle";
	downstream: Place;
	upstream: Place;
};
export type EndStream = StreamBase & {
	area: "end";
	upstream: Place;
};

export type Stream = Beginstream | MiddeStream | EndStream;
