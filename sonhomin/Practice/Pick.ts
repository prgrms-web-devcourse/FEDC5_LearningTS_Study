...
/*
  ...
  type MyKeys = keyof MyObject;
  // MyKeys는 "name" | "age" | "city"라는 유니온 타입이 됩니다.
  
  type MyIndexedObject = {
    [P in MyKeys]: string;
  };
  
  // MyIndexedObject는 { name: string, age: string, city: string } 타입이 됩니다.
